...
<body>
	<div class="container">
		...
		<form class="container" action="/home/update-can-bo" method="POST">
			...
			<div class="form-group row">
				<label for="gender" class="col-md-3 col-form-label"><b>Gioi
						Tinh </b></label>
				<div class="col-sm-9">
					<input type="radio" name="gender" value="1" checked> Nam <input
						type="radio" name="gender" value="0"
						${canBo.gender==0 ? 'checked' : '' }> Nu
				</div>

			</div>
			
			<div class="form-group row">
				<label for="address" class="col-md-3 col-form-label"><b>Dia Chi</b></label>
				<div class="col-sm-9">
					
					<input type="text" class="form-control mb-2 mr-sm-2 "
						required="required" name="address" placeholder="Enter address"
						id="address" value="${canBo.address}">
				</div>
